...
namespace SecureBootWatcher.Shared.Configuration
{
    ...
    public sealed class SinkOptions
    {
        ...
        /// <summary>
        /// Priority order for sinks. Format: "AzureFunction,WebApi,FileShare".
        /// Sinks are tried in this order. If not specified, default order is: AzureFunction, WebApi, FileShare.
        /// Only enabled sinks are executed.
        /// </summary>
        public string SinkPriority { get; set; } = "AzureFunction,WebApi,FileShare";
