...
using WindowsVersionsCore.Services.BackgroundTasks;
using Serilog;
...
{
    client.DefaultRequestHeaders.Add("User-Agent", "WindowsVersionScraper");
...
{
    builder.Services.AddHostedService<WindowsVersionScraper>();
}
...
builder.Services.AddSwaggerGen(c =>
{
    ...
    {
        Title = "Windows Versions API",
        Version = "v1",
        Description = "API for Windows 10 and Windows 11 version tracking",
        Contact = new OpenApiContact
        {
            Name = "Windows Versions Core",
            Url = new Uri("https://github.com/robgrame/WindowsVersionsCore")
        }
    });
...
app.UseSwaggerUI(c =>
{
    c.SwaggerEndpoint("/swagger/v1/swagger.json", "Windows Versions API v1");
    c.RoutePrefix = "swagger";
    c.DocumentTitle = "Windows Versions API";
    c.EnableDeepLinking();
...
// Add any specific rewrite rules here if needed
