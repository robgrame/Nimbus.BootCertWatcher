        ...
        public static List<WindowsVersion> CleanWindowsVersions(List<WindowsVersion> versions)
        {
            ...
            foreach (var editionGroup in versionsByEdition)
            {
                ...
                if (regularVersions.Any())
                {
                    ...
                    if (currentVersionMap.TryGetValue(editionGroup.Key, out string currentVersionStr))
                    {
                ...
                if (ltscVersions.Any())
                {
                    ...
                    if (ltscVersionMap.TryGetValue(editionGroup.Key, out string currentLtscStr))
                    {
